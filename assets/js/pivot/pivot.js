(function() {
  ...
  callWithJQuery(function($) {
    ...
    pivotTableRenderer = function(pivotData, opts) {
      ...
      result.className = "pvtTable data-table";
    ...
    val = (val != null) ? val : 0;
      ...
      // return $("<div style='overflow:scroll;overflow-y:hidden;'>").append(result);
      return result;
    };
    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
      ...
      try {
        ...
        uiTable = $("<table>", {
          "class": "pvtUi table table-bordered table-condensed"
        });
        ...
        colList = $("<td class='col-md-1'>").addClass('pvtAxisContainer pvtUnused').html('<b>Unused Fields</b>');
      ...
      // $("<input>").attr("type", "checkbox").attr("checked", true).bind("click", function(){
      //   if (this.checked) {
      ...
      /*
            btns.append($("<button>", {
              type: "button", class: 'btn btn-flat btn-xs btn-danger',
            ...
            $("<input>").attr("type", "checkbox").attr("checked", !filterItemExcluded).appendTo(filterItem).bind('click', function(){
              if (this.checked) {
                return valueList.find("input:visible").prop("checked", true);
              } else {
                return valueList.find("input:visible").prop("checked", false);
            ...
            filterItem.append($("<span>").text('Select All'));
      ...
      class: 'btn btn-flat btn-xs btn-success', 
          }).text("Close").bind("click", updateFilter));
        ...
        $("<td class='col-md-1'>").addClass('pvtVals').appendTo(tr1).append(aggregator);
        $("<td class='col-md-10'>").addClass('pvtAxisContainer pvtHorizList pvtCols').html('<b>Columns</b>').appendTo(tr1);
        tr2 = $("<tr>").appendTo(uiTable);
        tr2.append($("<td class='col-md-1'>").addClass('pvtAxisContainer pvtRows').attr("valign", "top").html('<b>Rows</b>'));
        pivotTable = $("<td class='col-md-10'>").attr("valign", "top").addClass('pvtRendererArea').appendTo(tr2);
        if (opts.unusedAttrsVertical === true || unusedAttrsVerticalAutoOverride) {
