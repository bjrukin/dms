	...
	<div class="form_fields_area">
		...
		<div class="row">
			<div style="float:right; ">
				<div class="btn-group">
					<button class="btn btn-default">Print</button>&nbsp
...
<script language="javascript" type="text/javascript">
	...
	$(function(){
		...
		$("#jqxGridPurchase_method").jqxGrid({
			...
			// { text: 'Part No.',datafield: 'part_id', columntype: 'dropdownlist', width: 150,filterable: true,renderer: gridColumnsRenderer, editable: false, hidden},
