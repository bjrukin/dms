		...
		<div class="row">
			<div class="col-xs-12 connectedSortable">
				...
				<div id='jqxGridSparepartToolbar' class='grid-toolbar'>
					...
					<button type="button" class="btn btn-success btn-flat btn-xs" data-toggle="modal" data-target="#locationModal">Generate  Location Barcode</button>
				</div>
...
<div id="locationModal" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-6"><input id='location' class='text_input' name='location'></div>

					<div class="col-md-12" id="save_barcode">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" id="generate_barcode">Generate</button>
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
			</div>
		</div>
...
<script type="text/javascript">
	...
	$("#generate_barcode").on('click', function () {
		...
		$.ajax({
		type: "POST",
		url: '<?php echo site_url("admin/msil_orders_spareparts/generate_barcode"); ?>',
		data: {location:location},
		success: function (result) {
			var result = eval('('+result+')');
			
			if (result.barcodes) {
					var html = '<button type="button" class="btn btn-default"><a href="<?php echo base_url('uploads/barcodes');?>'+'/'+result.barcodes+'.jpg" download>Download</a></button>';
					$('#save_barcode').append(html);
