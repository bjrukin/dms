		...
		<div class="content-wrapper">
			<div class="container">  
				<section class="invoice" style="max-width: 210mm;">
					...
					<h4>
						Invoice Number: <b><?php echo $rows[0]->invoice_no?></b>
					</h4>
					<h5>
						Invoice Number: <b><?php echo $rows[0]->invoice_no?></b>
					</h5>
					...
					<table cellspacing="0" cellpadding="0" style="width: 100%; border-collapse: collapse;" border="1">
						<tr>
							...
							<th style="width:250px;padding-top:7px; padding-left: 10px;">Dealer Name</th>	
						...
						<?php foreach ($rows as $key => $value): ?>
							...
							<tr> 
								...
								<td  style="padding-top:7px;padding-left:10px;"><?php echo $value->dealer_name;?></td>
							...
							?>
						<?php endforeach; ?>
						<tr><td colspan="3" style="text-align:right">Total Quantity</td><td colspan="3" style="padding-left: 10px"><?php echo $total;?></td></tr>
					</table>
				</section>
			</div>
		</div>
