...
//        $index = array('dispatch_date', 'order_no', 'vehicle_name', 'variant', 'color', 'chass_no', 'engine_no', 'ait_reference_no', 'invoice_no', 'invoice_date', 'month', 'year');
        $index = array('dispatch_date', 'order_no', 'vehicle_name', 'variant', 'color', 'chass_no', 'engine_no', 'ait_reference_no', 'invoice_no', 'invoice_date', 'month', 'year','transit','indian_stock_yard','indian_custom','nepal_custom','stock_yard','reached_date','dealer_name','repair_date');
        $raw_data = array();
        $data = array();
        $view_data = array();
