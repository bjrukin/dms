...
// CG working    
    function read_file() {
        ...
        $index = array('dispatch_date', 'order_no', 'vehicle_name', 'variant', 'color', 'chass_no', 'engine_no', 'ait_reference_no', 'invoice_no', 'invoice_date', 'month', 'year','key_no','company_name');
        $raw_data = array();
        $data = array();
        $view_data = array();
