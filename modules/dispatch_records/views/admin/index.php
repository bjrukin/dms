...
<div id="jqxPopupWindowDispatch_record">
    ...
    <div class="form_fields_area">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td><input id='chass_no' class='text_input' name='chass_no'></td>
            </tr>
            <tr>
        ...
        <div class="form_fields_area">
            ...
            <table class="form-table">
                ...
                <tr id="act_location">
                    ...
                    <td>
                        <select name="label" class="jqx-listmenu-item jqx-fill-state-small jqx-item" id="track_record" onchange="date_box_setting()">
    ...
    <!-- custom movement date -->
    <div id="jqxPopupWindowCustom_movement">
        <div class='jqxExpander-custom-div'>
            <span class='popup_title' id="window_poptup_track_title">Track Form</span>
        </div>
        <div class="form_fields_area">
            <?php echo form_open('', array('id' => 'form-custom_movements', 'onsubmit' => 'return false')); ?>
            <table class="form-table">
                <input type = "hidden" name = "id" id = "custom_movement_id"/>
                <tr>
                    <td><label for="Date">India Custom Movement Date</label></td>
                    <td><div id='india_custom_movement_date' class='date_box' name='india_custom_movement_date'></div></td>
                </tr>
                <tr>
                    <td><label for="Date">Nepal Custom Movement Date</label></td>
                    <td><div id='nepal_custom_movement_date' class='date_box' name='nepal_custom_movement_date'></div></td>
                </tr>
                <tr>
                    <th colspan="2">
                        <button type="button" class="btn btn-success btn-xs btn-flat" id="jqxCustom_movementSubmitButton"><?php echo lang('general_save'); ?></button>
                        <button type="button" class="btn btn-default btn-xs btn-flat" id="jqxCustom_movementCancelButton"><?php echo lang('general_cancel'); ?></button>
                    </th>
                </tr>
        ...
        <div class="form_fields_area">
            ...
            <table class="form-table app-table">
                <tr>
                    ...
                    <td><div id='fuel_info_added_date' class='date_box' name='fuel_info_added_date'></div></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td> <input type="number" step=0.001 name="fuel_quantity" class="text_input" id="fuel_quantity"></td>
                </tr>
                <tr>
                    <td> <label><span>Opening Kms:</span></label> </td>
                    <td> <div name="fuel_opening_kms" class="number_general" id="fuel_opening_kms" onchange="calculate_total_kms()"></div></td>
                </tr>
                <tr>
                    <td> <label><span>Closing Kms:</span></label> </td>
                    <td> <div name="fuel_closing_kms" class="number_general" id="fuel_closing_kms" onchange="calculate_total_kms()"></div></td>
                </tr>
                <tr>
                    <td> <label><span>Kms:</span></label> </td>
                    <td> <div name="fuel_kms" class="number_general" id="fuel_kms"></div></td>
                </tr>
                <tr>
                    <td> <label><span>Customer Name:</span></label> </td>
                    <td> <input type="text" name="fuel_customer" class="text_input" id="fuel_customer"></td>
                </tr>
                <tr>
                    <td> <label><span>Mobile Number:</span></label> </td>
                    <td> <input type="text" name="fuel_customer_number" class="text_input" id="fuel_customer_number"></td>
                </tr>
                <tr>
                    <td> <label><span>Month:</span></label> </td>
                    <td> <div name="fuel_month" id="fuel_month"></div></td>
                </tr>
                <tr>
                    <td> <label><span>Executive Name:</span></label> </td>
                    <td> <div name="fuel_executive" id="fuel_executive"></div></td>
                </tr>
                <tr>
                    <td> <label><span>Report By:</span></label> </td>
                    <td> <input type="text" name="fuel_reported_by" class="text_input" id="fuel_reported_by"></td>
                </tr>
                <tr>
                    <td> <label><span>Remarks:</span></label> </td>
                    <td> <input type="text" name="fuel_remarks" class="text_input" id="fuel_remarks"></td>
                </tr>
                <tr>
                    <th colspan="3">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function date_box_setting(){
            track_record = $('#track_record').val();
            if(track_record == 'indian_custom' || track_record == 'nepal_custom'){
                $(".date_box").jqxDateTimeInput({ width: 195, height: 25, formatString: formatString_yyyy_MM_dd, theme: theme, min: new Date(Date.now() - 864e5) });
            }else{
                $(".date_box").jqxDateTimeInput({ width: 195, height: 25, formatString: formatString_yyyy_MM_dd, theme: theme, min: new Date(0,0,0) });
            }
        }

        $(function () {

            var is_yatayat = '<?php is_yatayat(); ?>';
            //mst_vehicles
            ...
            $("#vehicle_id").bind('select', function (event) {
                ...
                var variantDataSource  = {
                    url : '<?php echo site_url("admin/dispatch_records/get_variants_combo_json"); ?>',
                    datatype: 'json',
                    datafields: [
            ...
            $("#variant_id").bind('select', function (event) {
                ...
                var colorDataSource  = {
                    url : '<?php echo site_url("admin/dispatch_records/get_colors_combo_json"); ?>',
                    datatype: 'json',
                    datafields: [
           ...
           $("#stock_yard_id").jqxComboBox({
            ...
            var fuel_location = ["INDIA STOCK TO INDIA CUSTOMS","INDIA CUSTOMS TO NEPAL CUSTOMS","NEPAL CUSTOMS TO CG stock Yard","BHW TO KTM/BRJ/DEALER/INTERNAL YARD","BRJ TO KTM/BHW/DEALER/INTERNAL YARD","DEALER TO DEALER TRANSFERS","SHOWROOM TEST DRIVE","KTM TO BRJ/BHW/DEALER/INTERNAL YARD", "NAXAL", "DHOBIGHAT", "THAPATHALI"];
           ...
           var dispatch_recordsDataSource =
           {
            ...
            {name: 'vehicle_register_date', type: 'date'},
            ...
            {name: 'india_custom_movement_date', type: 'date'},
            {name: 'india_custom_movement_date_np', type: 'string'},
            {name: 'nepal_custom_movement_date', type: 'date'},
            {name: 'nepal_custom_movement_date_np', type: 'string'},
            ...
            pager: function (pagenum, pagesize, oldpagenum) {
                ...
                $("#jqxGridDispatch_record").jqxGrid({
                    ...
                    {
                        text: 'Action', datafield: 'action', width: 120, sortable: false, filterable: false, pinned: true, align: 'center', cellsalign: 'center', cellclassname: 'grid-column-center',
                        cellsrenderer: function (index) {
                            ...
                            <?php else: ?>
                                ...
                                e += '<a href="javascript:void(0)" onclick="view_kms(' + index + '); return false;" title="View Fuel and Kms"><i class="fa fa-eye" aria-hidden="true"></i></a>&nbsp';
                                e += '<a href="javascript:void(0)" onclick="custom_movement_date(' + index + '); return false;" title="Custom Movement Dates"><i class="fa fa-calendar" aria-hidden="true"></i></a>';
                    ...
                    {text: '<?php echo lang("color_id"); ?>', datafield: 'color_code', width: 120, filterable: true, renderer: gridColumnsRenderer},
                    {text: '<?php echo lang("color_name"); ?>', datafield: 'color_name', width: 150, filterable: true, renderer: gridColumnsRenderer},
                    {text: '<?php echo lang("dispatch_date"); ?>', datafield: 'dispatch_date', width: 120, filterable: true, renderer: gridColumnsRenderer, columntype: 'date', filtertype: 'range', cellsformat: formatString_yyyy_MM_dd},
                    ...
                    {text: '<?php echo lang("india_custom_movement_date"); ?>', datafield: 'india_custom_movement_date', width: 220, filterable: true,  renderer: gridColumnsRenderer, columntype: 'date', filtertype: 'range', cellsformat: formatString_yyyy_MM_dd},
                  
                    {text: '<?php echo lang("nepal_custom_movement_date"); ?>', datafield: 'nepal_custom_movement_date', width: 220, filterable: true,  renderer: gridColumnsRenderer, columntype: 'date', filtertype: 'range', cellsformat: formatString_yyyy_MM_dd},
                    ...
                    {text: 'Registration Date', datafield: 'vehicle_register_date', width: 220, filterable: true,  renderer: gridColumnsRenderer, columntype: 'date', filtertype: 'range', cellsformat: formatString_yyyy_MM_dd},
                    {text: 'LC Number', datafield: 'lc_number',  width: 150, filterable: true, renderer: gridColumnsRenderer},
                    ],
...
$(document).on('click', '#jqxGridDispatch_recordInsert', function () {
    openPopupWindow('jqxPopupWindowDispatch_record', '<?php echo lang("general_add") . "&nbsp;" . $header; ?>');
        ...
        $('#form-Fuel_kms').jqxValidator({
         ...
         { input: '#fuel_info_added_date', message: 'Required', action: 'blur', 
         rule: function(input) {
             val = $('#fuel_info_added_date').val();
             return (val == '' || val == null || val == 0) ? false: true;
         }},
         { input: '#fuel_remarks', message: 'Required', action: 'blur', 
         rule: function(input) {
             val = $('#fuel_remarks').val();
             return (val == '' || val == null || val == 0) ? false: true;
         }},
        ...
        $("#jqxPopupWindowCustom_movement").jqxWindow({
            theme: theme,
            width: '75%',
            maxWidth: '75%',
            height: '75%',
        ...
        $("#jqxCustom_movementCancelButton").on('click', function () {
            reset_form_dispatch_records();
            $('#jqxPopupWindowCustom_movement').jqxWindow('close');
        });
     ...
     $("#jqxCustom_movementSubmitButton").on('click', function () {
        saveCustom_movementRecord();
     });
...
//    for custom movement
function saveCustom_movementRecord() {
    var data = $("#form-custom_movements").serialize();

    $('#jqxPopupWindowCustom_movement').block({
        message: '<span>Processing your request. Please be patient.</span>',
        css: {
            width: '75%',
            border: 'none',
    ...
    $.ajax({
        type: "POST",
        url: '<?php echo site_url("admin/dispatch_records/custom_movement"); ?>',
        data: data,
        success: function (result) {
            var result = eval('(' + result + ')');
            if (result.success) {
            ...
            $('#jqxPopupWindowCustom_movement').unblock();
        }
    });
}
...
//    for custom mobement date form
function custom_movement_date(index){
    var row = $("#jqxGridDispatch_record").jqxGrid('getrowdata', index);
    if (row) {
        $('#custom_movement_id').val(row.id);
        $('#india_custom_movement_date').val(row.india_custom_movement_date);
        $('#nepal_custom_movement_date').val(row.nepal_custom_movement_date);
        openPopupWindow('jqxPopupWindowCustom_movement', '<?php echo lang("general_edit") . "&nbsp;" . $header; ?>');
    }
}
...
function view_kms(index){
    ...
    {     
        ...
        {
            $('#view_fuel_kms').html('');
            $('#view_fuel_kms').append('<tr> <th>Date</th> <th>Location</th> <th>Fuel</th> <th>Opening Kms</th> <th>Closing Kms</th> <th>Kms</th><th>Remarks</th> <th>Reported By</th> </tr>');
            $.each(result.data,function(key,val)
            {
                $('#view_fuel_kms').append('<tr><td>'+val.date+'</td><td>'+val.location+'</td><td>'+val.fuel+'</td> <td>'+ val.opening_kms +'</td> <td>'+ val.closing_kms +'</td> <td>'+val.kms+'</td><td>'+val.fuel_remarks+'</td> <td>'+ val.reported_by +'</td></tr>')
            });
        },'json');    
...
<script type="text/javascript">
    function calculate_total_kms() {
        var opening = parseFloat($('#fuel_opening_kms').val());
        var closing = parseFloat($('#fuel_closing_kms').val());
        ...
        if(closing){
            if(total < 0){
                ...
                $('#fuel_kms').val(0);
                $('#fuel_opening_kms').val(0);
                $('#fuel_closing_kms').val(0);
            }else{
                $('#fuel_kms').val(total);
            }
        }
