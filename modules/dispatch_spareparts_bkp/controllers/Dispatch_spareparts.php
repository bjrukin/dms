...
public function save()
{
    ...
    {   
        ...
        $index = array('part_code','quantity');
        $raw_data = array();
        $view_data = array();
        ...
        foreach ($raw_data as $key => $value) 
        {
            ...
            $imported_data[$key]['order_no'] = (($order_no->order_no?$order_no->order_no:0) +1);
            $imported_data[$key]['final_order_no'] = $orderno;
            $imported_data[$key]['order_type'] = $order_type;
            $imported_data[$key]['date'] = date('Y-m-d');            
            $imported_data[$key]['nep_date'] = get_nepali_date(date('Y-m-d'),'nep');   
