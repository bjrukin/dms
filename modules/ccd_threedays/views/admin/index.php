	...
	<div class="form_fields_area">
		...
		<table class="form-table">
			...
			<tr class="inq_detail" style="display: none">
				<th colspan="2">PDI Satisfaction Score (PSS):</th>
			</tr>
			<tr class="inq_detail" style="display: none">
				...
				<td><div id='cleanliness_of_car' class='array_decisions' name='cleanliness_of_car'></div></td>
			</tr>
			<tr class="inq_detail" style="display: none">
				<td><label for='fit_and_finish'><?php echo lang('fit_and_finish')?></label></td>
				<td><div id='fit_and_finish' class='array_decisions' name='fit_and_finish'></div></td>
			</tr>
			<tr class="inq_detail" style="display: none">
				<td><label for='pss_score'><?php echo lang('pss_score')?></label></td>
				<td><input id='pss_score' class="general_number" readonly name='pss_score'></td>
			</tr>
			<tr class="inq_detail" style="display: none">
				<th colspan="2">Sales Satisfaction Score (SSS):</th>
			</tr>
			<tr class="inq_detail" style="display: none">
			...
			<tr class="inq_detail" style="display: none">
				<?php /*<td><label for='basic_features'><?php echo lang('basic_features')?></label></td>
				...
				<td><label for='payment_receipt'><?php echo lang('payment_receipt')?></label></td>
				<td><div id='payment_receipt' class='array_decisions' name='payment_receipt'></div></td>
			</tr>
			<tr class="inq_detail" style="display: none">
				...
				<td><label for='tool_set'><?php echo lang('tool_set')?></label></td>
				<td><div id='tool_set' class='array_decisions' name='tool_set'></div></td>
				<?php /*<td><label for='ccd_details'><?php echo lang('ccd_details')?></label></td>
				<td><div id='ccd_details' class='array_decisions' name='ccd_details'></div></td>*/?>
			</tr>
			<tr class="inq_detail" style="display: none">
				<td><label for='sss_score'><?php echo lang('sss_score')?></label></td>
				<td><input id='sss_score' class="general_number" name='sss_score' readonly></td>
			</tr>
			<tr class="inq_detail" style="display: none">
				<td><label for='total_score'><?php echo lang('total_score')?></label></td>
				<td><input id='total_score' class="general_number" name='total_score' readonly></td>
			</tr>
			<tr class="inq_detail" style="display: none">
			...
			<tr class="inq_detail" style="display: none">
				...
				<td><input type="text" id='recommend_name1' name='recommend_name1'></td>
				<td><label for='recommend_contact1'><?php echo lang('recommend_contact1')?></label></td>
				<td><input id='recommend_contact1' class='text' name='recommend_contact1'></td>
			</tr>
			<tr class="inq_detail" style="display: none">
				<td><label for='recommend_name2'><?php echo lang('recommend_name2')?></label></td>
				<td><input type="text" id='recommend_name2' name='recommend_name2'></td>
				<td><label for='recommend_contact2'><?php echo lang('recommend_contact2')?></label></td>
				<td><input id='recommend_contact2' class='text' name='recommend_contact2'></td>
			</tr>
			<tr>
				<th colspan="2">
...
<script language="javascript" type="text/javascript">
	...
	$(function(){
		...
		var ccd_threedaysDataSource =
		{
			...
			url: '<?php echo site_url("admin/ccd_threedays/json"); ?>',
...
function editCcd_threedayRecord(index){
	...
	$('#delivered_on_time').jqxComboBox('clearSelection');
	$('#cleanliness_of_car').jqxComboBox('clearSelection');
	$('#owner_manual').jqxComboBox('clearSelection');
	$('#service_coupon').jqxComboBox('clearSelection');
	$('#warrenty_card').jqxComboBox('clearSelection');
	$('#delivery_sheet').jqxComboBox('clearSelection');
	$('#remarks').jqxComboBox('clearSelection');
	$('#payment_receipt').jqxComboBox('clearSelection');
	$('#tool_set').jqxComboBox('clearSelection');
	$('#fit_and_finish').jqxComboBox('clearSelection');
	...
	if (row) {
		...
		// $('#payment_receipt').jqxComboBox('val',row.delivery_sheet);
		// $('#tool_set').jqxComboBox('val',row.delivery_sheet);
		// $('#ccd_details').jqxComboBox('val',row.ccd_details);
		$('#remarks').jqxComboBox('val','');
		// $('#remarks').jqxComboBox('val',row.remarks);
		$('#voc').val('');
		// $('#voc').val(row.voc);
		$('#recommend_name1').val();
		$('#recommend_name2').val();
		$('#recommend_contact1').val();
		$('#recommend_contact2').val();
...
<script type="text/javascript">
	$(document).on('change','.array_decisions', function () { 
		var delivered_on_time = $('#delivered_on_time').jqxComboBox('val');
		var cleanliness_of_car = $('#cleanliness_of_car').jqxComboBox('val');
		var fit_and_finish = $('#fit_and_finish').jqxComboBox('val');
		var service_coupon = $('#service_coupon').jqxComboBox('val');
		var warrenty_card = $('#warrenty_card').jqxComboBox('val');
		var owner_manual = $('#owner_manual').jqxComboBox('val');
		var payment_receipt = $('#payment_receipt').jqxComboBox('val');
		var delivery_sheet = $('#delivery_sheet').jqxComboBox('val');
		var tool_set = $('#tool_set').jqxComboBox('val');

		var pss = 0;
		var sss = 0;
		var total = 0;

		if(delivered_on_time == 'Yes'){
			pss += 33;
		}
		if(cleanliness_of_car == 'Yes'){
			pss += 33;
		}
		if(fit_and_finish == 'Yes'){
			pss += 34;
		}
		if(service_coupon == 'Yes'){
			sss += 16;
		}
		if(warrenty_card == 'Yes'){
			sss += 16;
		}
		if(owner_manual == 'Yes'){
			sss += 16;
		}
		if(payment_receipt == 'Yes'){
			sss += 16;
		}
		if(delivery_sheet == 'Yes'){
			sss += 16;
		}
		if(tool_set == 'Yes'){
			sss += 20;
