...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><?php echo 'Target Report'; ?><small>Retail Target Report</small></h1>
		<ol class="breadcrumb">
	        <li><a href="<?php echo site_url();?>"><?php echo lang('menu_home');?></a></li>
	        <li><a href="<?php echo site_url('admin/crm-reports');?>"><?php echo lang('crm_reports');?></a></li>
	        <li class="active"><?php echo 'Retail Target Records'; ?></li>
      </ol>
	</section>
	<!-- Main content -->
...
<script type="text/javascript">
   $("#search_btn").on('click', function (event) {
            ...
            var target_source =
            {
                ...
                { name: 'total_retail', type: 'number' },
                { name: 'total_retail_target', type: 'number' },
                ...
                type: 'post',
                url: '<?php echo site_url('crm-reports/retail_target_report/json'); ?>'
            };
            ...
            $("#jqxGrid_mechanic_earning").jqxGrid(
            {
                ...
                { text: '<?php echo "Retail Target" ?>', datafield: 'total_retail_target', width:'10%',cellsformat: 'd2', aggregates: ['sum'] },
                { text: '<?php echo "Total Retail"; ?>', datafield: 'total_retail', width:'10%',cellsformat: 'd2', aggregates: ['sum'] },
                ]
            });
        });
