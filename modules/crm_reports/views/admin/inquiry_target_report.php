...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><?php echo 'Target Report'; ?><small>Inquiry Target Report</small></h1>
		<ol class="breadcrumb">
	        <li><a href="<?php echo site_url();?>"><?php echo lang('menu_home');?></a></li>
	        <li><a href="<?php echo site_url('admin/crm-reports');?>"><?php echo lang('crm_reports');?></a></li>
	        <li class="active"><?php echo 'Inquiry Target Records'; ?></li>
      </ol>
	</section>
	<!-- Main content -->
...
<script type="text/javascript">
   $("#search_btn").on('click', function (event) {
            ...
            var target_source =
            {
                ...
                { name: 'total_inquiry', type: 'number' },
                { name: 'total_inquiry_target', type: 'number' },
                ...
                type: 'post',
                url: '<?php echo site_url('crm-reports/inquiry_target_report/json'); ?>'
            };
            ...
            $("#jqxGrid_mechanic_earning").jqxGrid(
            {
                ...
                { text: '<?php echo "Inquiry Target" ?>', datafield: 'total_inquiry_target', width:'10%',cellsformat: 'd2', aggregates: ['sum'] },
                { text: '<?php echo "Total Inquiry"; ?>', datafield: 'total_inquiry', width:'10%',cellsformat: 'd2', aggregates: ['sum'] },
                ]
            });
        });
