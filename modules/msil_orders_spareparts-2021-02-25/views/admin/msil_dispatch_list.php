...
<!-- 
					...
					<?php else: ?>
						<a class="btn btn-xs  btn-primary" href="<?php echo site_url('msil_orders_spareparts/print_binning').'/'.$invoice_no;?>" target="_blank">Print Binning List</a>
					<?php endif; ?>
...
<script language="javascript" type="text/javascript">
	...
	$("#jqxGridDispatch_list").jqxGrid({
		...
		{ text: '<?php echo lang("binning_status"); ?>',datafield: 'binning_status',width: 150, align:'center', cellsalign:'center', filterable: true,renderer: gridColumnsRenderer },
