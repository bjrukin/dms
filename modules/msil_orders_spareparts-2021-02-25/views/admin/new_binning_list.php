				...
				<section class="invoice" style="max-width: 210mm;">
					...
					<table cellspacing="0" cellpadding="0" style="width: 100%; border-collapse: collapse;" border="1">
						<tr>
							...
							<th style="width:20px;padding-top:7px; padding-left: 10px;"> Box Qty</th>	
							<th style="width:250px;padding-top:7px; padding-left: 10px;">Scanner Name</th>	
							<th style="width:250px;padding-top:7px; padding-left: 10px;">Scan Device Name</th>	
						...
						<?php foreach ($rows as $key => $value): ?>
							...
							<tr> 
								...
								<td  style="padding-top:7px;padding-left:10px;"><?php echo $value->box_quantity;?></td>						     
								<td  style="padding-top:7px;padding-left:10px;"><?php echo $value->scanner_name;?></td>
								<td  style="padding-top:7px;padding-left:10px;"><?php echo $value->device_name;?></td>
