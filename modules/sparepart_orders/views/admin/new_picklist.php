			...
			<div class="container">  
				<section class="invoice" style="max-width: 210mm;">
					<table cellspacing="0" cellpadding="0" style="width: 100%; border-collapse: collapse;">
						...
						<tr>
							<td>Picklist Group: <?php echo @$picklist_group;?></td>
							<td class="center"></td>
						...
						<?php foreach ($rows as $key => $value): ?>
							<tr> 
								...
								<td  style="padding-top:7px;padding-left:10px;">
									<?php echo ($value->location)?$value->location:'not in action';?>
									<?php if($value->location != $value->ordered_location){?>
										(<?php echo ($value->ordered_location)?$value->ordered_location:'not in action';?>)
									<?php }?>
								</td>
