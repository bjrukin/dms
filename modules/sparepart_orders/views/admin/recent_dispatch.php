...
<div id="jqxPopupWindowAddGrn">
	...
	<div class="form_fields_area">
		...
		<div class="row">
			<div class="col-md-2"><label for="Bill"><?php echo 'Bill';?></label></div>
			<div class="col-md-4"><div id="bill_concat_form"></div></div>
...
<script language="javascript" type="text/javascript">
	...
	$("#jqxRecent_dispatchlist").jqxGrid({
		...
		{ text: '<?php echo lang("order_no"); ?>',datafield: 'order_no',editable: false, width: 150,filterable: true,renderer: gridColumnsRenderer },
...
function add_grn(index){
	...
	if (row) {
		...
		$('#bill_concat_form').html(row.bill_concat);
		$('#bill_no').html(row.bill_no);
		$('#dispatched_date').html(row.dispatched_date);		
		/*$.post('<?php echo site_url('sparepart_orders/get_recent_dispatch_list') ?>',{bill_no : row.bill_no, dispatched_date:row.dispatched_date},function(result)
		{
		...
		var recent_dispatchDataSource =
		{
			...
			url: '<?php echo site_url("sparepart_orders/get_recent_dispatch_list")?>',
