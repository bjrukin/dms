...
<body>
	<div class="page">
			<table cellspacing="0" cellpadding="0" width="750px">
				<!-- ------------- Header Starts ------------- -->
				<tr>
					<td colspan="8" style="text-align:center;padding:0px"> <h2><?php echo 'Shree Himalayan Enterprises Pvt. Ltd.'; ?></h2> </td>
				</tr>
				<tr>
					<td colspan="8" style="text-align:center;"> <?php echo 'Satungal, Kathmandu'; ?></td>
				</tr>
				<tr>
					<td colspan="8" style="text-align:center;"> Tel No: <?php echo '01-4314224'; ?> </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3" style="width:210px;padding-top:20px"><span style="padding-right:10px">: GP-<?php echo @sprintf('%05d',$gatepass_no); ?></td>
				...
				<tr>
					...
					<td colspan="3" style="width:210px;padding-top:20px"><span style="padding-right:10px">: Rs.<?php echo @(moneyFormat($bill_data->amount)); ?></td>
