...
<div id="jqxPopupWindowWarranty_claim">
	...
	<div class="form_fields_area">
		...
		<div class="row">
			<div class="col-md-2"> <?php echo ('customer_name'); ?> </div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="pull-right">
					...
					<button type="button" class="btn btn-default btn-sm btn-flat" onclick="reset_form_warranty_claims()"><?php echo ('reset'); ?></button>
					<button type="button" class="btn btn-success btn-sm btn-flat" id="jqxWarranty_claimSubmitButton"><?php echo lang('general_save'); ?></button>
					<button type="button" class="btn btn-default btn-sm btn-flat" id="jqxWarranty_claimCancelButton"><?php echo lang('general_cancel'); ?></button>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	$("#warranty_claim_list").jqxGrid({
		...
		{ text: '<?php echo ("selected"); ?>', datafield: 'selected', columntype: 'checkbox', width: 67 },
		// { text: '<?php echo ("part_id"); ?>',datafield: 'part_id',width: 150,filterable: true,renderer: gridColumnsRenderer, hidden: true },
		{ text: '<?php echo ("part_id"); ?>',datafield: 'part_code',width: 150,filterable: true,renderer: gridColumnsRenderer, editable: false },
		{ text: '<?php echo ("part_name"); ?>',datafield: 'part_name',filterable: true,renderer: gridColumnsRenderer, editable: false },
		{ text: '<?php echo ("quantity"); ?>',datafield: 'quantity',width: 150,filterable: true,renderer: gridColumnsRenderer, editable: false },
	...
	function get_from_jobno() {
		...
		$.post('<?php echo site_url('admin/warranty_claims/get_from_job'); ?>', {job_no: job_no}, function(result){
			if(result.rows[0] != null) {
				...
				$('#customer_name').val(result.user.full_name);
			}
