		...
		<div class="row">
			<div class="col-xs-12 connectedSortable">
				...
				<div id='jqxGridDaily_creditToolbar' class='grid-toolbar'>
					<button type="button" class="btn btn-primary btn-flat btn-xs" id="jqxGridDaily_creditInsert"><?php echo lang('general_create'); ?></button>
...
$(function(){
	...
	$("#jqxGridDaily_credit").jqxGrid({
		...
		columns: [
			...
			{ text: '<?php echo lang("credit_amount"); ?>',datafield: 'total_credit_amount',width: 150,filterable: true,renderer: gridColumnsRenderer },
