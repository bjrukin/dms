				...
				<div id='jqxTabs_jobcardDetailsView'>
					...
					<div class="tab_content">
						<div class="col-md-12">
							...
							<?php if(isset($grouped_jobcard[0]->issue_date)):?>
								<a href="<?php echo site_url('admin/job_cards/generate_excel?jobcard_group='.$jobcard->jobcard_group)?>"><button type="button" class="btn btn-danger btn-flat btn-xs" >Generate Excel</button></a>
							<?php endif;?>
						</div>
