...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><?php echo lang('foc_reports'); ?></li>
		</ol>
	</section>
		...
		<div class="col-md-12">
			<div class="box">
				...
				<div class="box-body" style="line-height:200%">
					<div class="row">
						<?php
						if((is_service_head() || is_national_service_manager() || is_admin() || is_ccd_incharge()  || is_service_finance()) || is_service_dealer_incharge())
						{
						?>
							<div class="col-md-6">
	...
	$(function(){
		...
		<?php
			...
			if(selection){
				...
				var excel_link = '<?php echo site_url('service_reports/foc_reports_dump')?>';  
			...
			// if (selection != null) {
				...
				$("#jqxGrid_foc_reports").jqxGrid(
				{
					...
					{ text: '<?php echo 'Dealer'; ?>', datafield: 'dealer_name', width:'18%' },
					{ text: '<?php echo lang("issue_date"); ?>', datafield: 'job_card_issue_date', width:'9%' },
					{ text: '<?php echo lang("jobcard_group"); ?>', datafield: 'jobcard_serial', width:'9%' },
					...
					{ text: '<?php echo 'Mobile'; ?>', datafield: 'mobile',width:'18%' },
					...
					{ text: '<?php echo 'Model'; ?>', datafield: 'vehicle_name', width:'15%', cellsrenderer   : function(row,columnfield,value){
