...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><?php echo 'Part Wise Billing'; ?></li>
		</ol>
	</section>
		...
		<div class="col-md-12">
			<div class="box">
				<div class="box-header" style="cursor: move;">
					...
					<h3 class="box-title"><?php echo 'Part Wise Billing'; ?></h3>
	...
	$(function(){
		...
		advicePartAdapter = new $.jqx.dataAdapter(advicePartSource,
		{
			formatData: function (data) {
				if ($("#new_job_id").jqxComboBox('searchString') != undefined) {
					data.name_startsWith = $("#new_job_id").jqxComboBox('searchString');
					return data;
				}
			}
		}
		...
		$("#date_range_submit").on('click', function (event) {
			...
			if(selection){
				...
				var excel_link = '<?php echo site_url('service_reports/get_part_wise_billing_summary_dump')?>';  
			...
			if (selection != null || new_job_id != null) {
				var pdi_reports_source =
				{
					...
					type: 'post',
					url: '<?php echo site_url('service_reports/get_part_wise_billing_summary/json'); ?>'
				};
				...
				$("#jqxGrid_pdi_reports").jqxGrid(
				{
					...
					{ text: '<?php echo 'Part Code'; ?>', datafield: 'part_code', width:'9%' },
					{ text: '<?php echo 'Part Name'; ?>', datafield: 'part_name', width:'9%' },
					{ text: '<?php echo 'Price'; ?>', datafield: 'price', width:'9%' ,cellsformat: 'd2', aggregates: ['sum'] },
					{ text: '<?php echo 'Quantity'; ?>', datafield: 'display_quantity', width:'9%' ,cellsformat: 'd2', aggregates: ['sum'] },
