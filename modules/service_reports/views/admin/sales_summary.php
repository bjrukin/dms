	...
	$(function(){
		...
		$("#date_range_submit").on('click', function (event) {
			...
			if(selection){
				...
				var excel_link = '<?php echo site_url('service_reports/sale_summary_excel_dump')?>';  
			...
			// if (selection != null) {
				var sales_summary_source =
				{
					...
					{ name: 'total_parts', type: 'float' },
					{ name: 'total_jobs', type: 'float' },
					{ name: 'total_vat_jobs', type: 'float' },
					{ name: 'total_vat_parts', type: 'float' },
					{ name: 'cash_discount', type: 'float' },
				...
				$("#jqxGrid_sales_summary").jqxGrid(
				{
					...
					{ text: '<?php echo 'Dealer'; ?>', datafield: 'dealer_name', },
					{ text: '<?php echo 'Mechanic'; ?>', datafield: 'mechanic_name', },
					{ text: '<?php echo 'Service Advisor'; ?>', datafield: 'service_advisor_name', },
					{ text: '<?php echo 'Total Jobs'; ?>', datafield: 'total_jobs',cellsformat: 'd2', aggregates: ['sum']},
					{ text: '<?php echo 'Total Parts'; ?>', datafield: 'total_parts',cellsformat: 'd2', aggregates: ['sum']},
					{ text: '<?php echo 'Vat Job'; ?>', datafield: 'total_vat_jobs',cellsformat: 'd2', aggregates: ['sum']},
					{ text: '<?php echo 'Vat Part'; ?>', datafield: 'total_vat_parts',cellsformat: 'd2', aggregates: ['sum']},
					{ text: '<?php echo 'Cash Discount'; ?>', datafield: 'cash_discount',cellsformat: 'd2', aggregates: ['sum']},
					{ text: '<?php echo 'Grand Total'; ?>', datafield: 'grand_total',cellsformat: 'd2', aggregates: ['sum']},
					]
				});
