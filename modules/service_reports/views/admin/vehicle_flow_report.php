...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><?php echo lang('vehicle_flow_report'); ?></li>
		</ol>
	</section>
		...
		<div class="col-md-12">
			<div class="box">
				<div class="box-header" style="cursor: move;">
					...
					<h3 class="box-title"><?php echo lang('vehicle_flow_report'); ?></h3>
	...
	$(function(){
		...
		$("#date_range_submit").on('click', function (event) {
			...
			if(selection){
				...
				var excel_link = '<?php echo site_url('service_reports/vehicle_flow_report_excel_dump')?>';  
			...
			// if (selection != null) {
				var dent_paint_source =
				{
					...
					type: 'post',
					url: '<?php echo site_url('service_reports/vehicle_flow_report/json'); ?>'
				};
				...
				$("#jqxGrid_dent_paint").jqxGrid(
				{
					...
					{ text: 'AMC', datafield: 'AMC', width:'9%',cellsformat: 'd2', aggregates: ['sum'] },
					{ text: 'FREE', datafield: 'FREE', width:'9%',cellsformat: 'd2', aggregates: ['sum'] },
					{ text: 'PAID(AW)', datafield: 'PAID(AW)', width:'9%',cellsformat: 'd2', aggregates: ['sum'] },
					{ text: 'PAID(UW)', datafield: 'PAID(UW)', width:'9%',cellsformat: 'd2', aggregates: ['sum'] },
					{ text: 'RUNNING REPAIR', datafield: 'RUNNING REPAIR', width:'9%',cellsformat: 'd2', aggregates: ['sum'] },
					{ text: 'ACCIDENTAL', datafield: 'ACCIDENTAL', width:'9%',cellsformat: 'd2', aggregates: ['sum'] },
					{ text: 'Other', datafield: 'Other', width:'9%',cellsformat: 'd2', aggregates: ['sum'] },
					{ text: 'PDI', datafield: 'PDI', width:'9%',cellsformat: 'd2', aggregates: ['sum'] },
					// { text: 'Total', datafield: 'productname', width: 170,
     //                  aggregates: ['sum',                         
     //                  ]
     //              },
		     		{
					text: 'Total', datafield: 'total', width:'9%', cellsformat: 'd2',sortable:false,filterable:false, align: 'center' , cellsalign: 'center', cellclassname: 'grid-column-center', 
                ...
                $.each(record,function(key,value){
                	if(key != 'uid' && key != 'dealer_name')
					{
						row_total += (Number.isInteger(parseInt(value)))?parseInt(value):0;
					}
                })        
                var row_totall = (isNaN(row_total)?0:row_total);
                var total = parseFloat(row_totall);
