...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			<?php echo lang('jobcard_billing'); ?>
			<!-- <small>Control panel</small> -->
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo site_url();?>"><?php echo lang('menu_home');?></a></li>
			
			<li class="active"><?php echo lang('jobcard_billing'); ?></li>
		</ol>
	</section>
		...
		<div class="col-md-12">
			<div class="box">
				<div class="box-header" style="cursor: move;">
					...
					<h3 class="box-title"><?php echo lang('jobcard_billing'); ?></h3>
				...
				<form method="post" action="<?php echo site_url('admin/job_cards/billingexcel_dump')?>">
