				...
				<div class="col-md-6">
					<fieldset id="fieldset-vehicle_details">
						...
						<div class="row">
							...
							<div class="col-md-4"><div type="text" name="vehicle_id" class="form-control input-sm part_vehicle_no" id="vehicle_id"></div></div>
						</div>
						<div class="row">
							<div class="col-md-2"><?php echo lang("variant_name") ?></div>
							<div class="col-md-4"><div type="text" name="variant_id" class="form-control input-sm part_vehicle_no" id="variant_id"></div></div>
							<div class="col-md-2"><?php echo lang("color_name") ?></div>
							<div class="col-md-4"><div type="text" name="color_id" class="form-control input-sm part_vehicle_no" id="color_id"></div></div>
						</div>
						<div class="row">
					...
					<fieldset>
						...
						<div class="row">
							...
							<div class="col-md-offset-3 col-md-3">
								<input type="number" name="cash_discount_amt" id="" onchange="estimate_cal_cash_discount_amt()" value="0" class="form-control input-sm">
							</div>
						</div>
						<div class="row">
...
<script language="javascript" type="text/javascript">
	...
	$(function(){
		...
		var partDataSource = {
			url : '<?php echo site_url("admin/estimate_details/get_spareparts_combo_json"); ?>',
			datatype: 'json',
			datafields: [
			{ name: 'id', type: 'number' },
...
<script type="text/javascript">
	function estimate_cal_cash_discount_amt() {
		var total_job = parseFloat($('#total_jobs').val());
		var total_parts = parseFloat($('#total_parts').val());
		...
		var discounted_amount = total_parts - total_discount_amount;
