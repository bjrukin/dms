			...
			<div class="col-xs-12 connectedSortable">				
				<fieldset>
					...
					<form action="<?php echo base_url('dispatch_spareparts/order_import') ?>" method="post" enctype="multipart/form-data">
						...
						<div class="col-md-2"><button class="btn btn-md btn-flat btn-success">Read</button></div>
					</form>
				</fieldset>
	...
	<div id="jqxPopupWindowAdd_Proforma">
		...
		<div class="form_fields_area">
			<form action="<?php echo site_url('admin/msil_orders_spareparts/pi_import') ?>" method="post" enctype="multipart/form-data">
				...
				<input type="file" name="userfile"><button>Read</button>
			</form>
		</div>
	</div>
	...
	$("#jqxGridMsil_grouped_order").jqxGrid({
		...
		{ text: '<?php echo lang("order_type"); ?>',datafield: 'order_type',width: 150,filterable: true,renderer: gridColumnsRenderer, align:'center', cellsalign:'center' },
		],
