            ...
            <div class="container">  
                <section class="invoice" style="max-width: 210mm;">     
                    ...
                    <table cellspacing="5" cellpadding="0" style="width:700px">
                        ...
                        <tr>
                            <td colspan="3">As a special privilege,we are pleased to offer you a net Cash discount of Rs.<b><?php echo moneyFormat($info->customer_discount_amount);?>/-</b> (Amount
                            ...
                            <tr>
                                ...
                                <td style="width:5%; padding-top: 15px;">:</td>
                                <td style="width:75%; padding-top: 15px;">Rs. <?php echo moneyFormat($info->quote_price - @$info->downpayment_amount); ?>
