...
var customer_followups = function(){
	...
	$("#jqxGridCustomer_followup").jqxGrid({
		...
		columns: [
			...
			{
				text: 'Action', datafield: 'action', width:75, sortable:false,filterable:false, pinned:true, align: 'center' , cellsalign: 'center', cellclassname: 'grid-column-center', cellclassname: cellclassname,
			...
			{ text: '<?php echo lang("followup_notes"); ?>',datafield: 'followup_notes', filterable: true,renderer: gridColumnsRenderer, cellclassname: cellclassname },
