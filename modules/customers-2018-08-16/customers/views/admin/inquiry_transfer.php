	...
	<div class="container">
		...
		<div class="staff_leave" style="display:none">			
			...
			<div class="row">
				...
				<div class="col-md-10"><input id="inquiry_transfer_quantity" type="text" name="quantity" class="text_input"></div>
			</div>
			<br/>
			<div class="row">
				<div class="col-md-12">
...
<script language="javascript" type="text/javascript">
	...
	$(function(){
		...
		$("#transfer_type").bind('select', function (event) {
			...
			else if(val == 'Dealer Staff Transfer')
			{
				$('.staff_leave').hide();
				$('.showroom_change').hide();
	...
	function save_inquiry_transfer()
	{
		...
		var quantity = $('#inquiry_transfer_quantity').val();
		$('.container').block({ 
