...
class Customer {
	...
	public function get_stock_records($dealer_id,$vehicle_id,$variant_id,$color_id) 
	{
		...
		return $this->CI->stock_record_model->findAll(array('dealer_id'=>$dealer_id,'vehicle_id'=>$vehicle_id,'variant_id'=>$variant_id,'color_id'=>$color_id,'dispatch_to_customers'=>NULL,'current_status <>'=>"damage",'received_date <>'=>NULL));
	}
	...
	{   
		...
		return array('msg'=>$msg,'success'=>$success,'required'=>$data['accessories_list']);
	}
