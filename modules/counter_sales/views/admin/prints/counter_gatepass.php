...
<body>
	<div class="page">
			<table cellspacing="0" cellpadding="0" width="750px">
				...
				<tr>
					<td colspan="2"  style="font-weight:bold;padding-top:20px; width: 100px;">Gate Pass No.</td>
					<td colspan="3" style="width:210px;padding-top:20px"><span style="padding-right:10px">:<?php echo $gatepass['gatepass_no']?></td>
					<td colspan="2"  style="font-weight:bold;padding-top:20px; width: 100px;">CounterSales No.</td>
					<td colspan="3" style="width:210px;padding-top:20px"><span style="padding-right:10px">:<?php echo $counter_sales_id?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3" style="width:210px;padding-top:20px">:<?php echo $gatepass['invoice_no']?></td>
				</tr>
