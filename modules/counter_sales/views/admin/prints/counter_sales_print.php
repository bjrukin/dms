	...
	<div class="page">
		<table cellspacing="0" cellpadding="0" width="750px">
			...
			<tr>
				...
				<td colspan="3" style="width:210px;padding-top:20px"><span style="padding-right:10px">:</span><?php echo @$invoice['invoice_prefix']. " ". @$invoice['invoice_no']; ?></td>
				<td style="padding-top:20px">Date</td>
				<td colspan="2" style="padding-top:20px"><span style="padding-right:10px">:</span><?php echo @$detail->date_time; ?></td>
			</tr>
			<tr>
				<td colspan="2" style="">Party Name</td>
				<td colspan="3" style="padding-top: 5px;"><span style="padding-right:10px">:</span><?php echo $invoice['full_name']; ?></td>
			</tr>
			<tr>
			...
			<?php if($parts): ?>
				<?php foreach ($parts as $key => $value): ?>
					<tr>
						...
						<td style="padding-top:10px;padding-left:20px"><?php echo $value->part_name; ?></td>
		...
		<table cellspacing="0" cellpadding="0" width="750px">
			...
			<tr>
				...
				<td style="padding-top:30px;text-align: right; padding-right: 5px;"><?php echo @$invoice['total_parts']; ?></td>
			</tr>
			<tr>
				<td colspan="6"></td>
				<td style="padding-top:10px;">Total Jobs</td>
				<td style="padding-top:10px;text-align: right; padding-right: 5px;"><?php echo @$invoice['total_jobs']; ?></td>
			</tr>
			<tr>
				<td colspan="6"></td>
				<td >Cash</td>
				<td style="padding-top:10px;text-align: right; padding-right: 5px;"><?php echo @$invoice['cash_discount_amt']; ?></td>
			</tr>
			<tr>
				<td colspan="6"></td>
				<td >Discount</td>
			...
			<tr>
				...
				<td style="border-bottom-style: groove;padding-top:10px;text-align: right; padding-right: 5px;"><?php echo @$invoice['vat_parts'] + @$invoice['vat_job']; ?></td>
			</tr>
			<tr>
				<td colspan="6"></td>
				<td style="border-bottom-style: groove;" >Net Amount</td>
				<td style="border-bottom-style: groove;padding-top:10px;text-align: right; padding-right: 5px;"><?php echo ($invoice['aro'] == FALSE)?$invoice['net_total'] : ($invoice['total_parts'] * 1.13) ; ?></td>
			</tr>
