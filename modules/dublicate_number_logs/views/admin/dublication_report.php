...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><?php echo lang('crm_reports'); ?><small>Dublication Report</small></h1>
		<ol class="breadcrumb">
...
$(function(){
	$("#date_range").jqxDateTimeInput({  value: null , width: 200, height: 25,  selectionMode: 'range', showFooter: true  });
...
function generateReport() {
 ...
 //    });
    ...
    $.ajax({
        type: "POST",
        url: '<?php echo site_url("admin/dublicate_number_logs/dublicate_number_report"); ?>',
        data: data,
