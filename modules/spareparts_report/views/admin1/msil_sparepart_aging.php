            ...
            <div class="box-body">
                ...
                <table class="table table-responsive table-striped">
                  <tr>
                    ...
                    <td><input type="text" class="text_input" name='days_interval'></input></td>
                    <td><label for='segment'>Segment</label></td>
                    <td><input type="text" name="segment" class="text_input"></div></td>
                    <td>
...
<script type="text/javascript">
    $(function(){
        ...
        spareparts_dealerDataAdapter = new $.jqx.dataAdapter(sparepartDataSource);
