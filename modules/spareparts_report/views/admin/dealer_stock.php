            ...
            <div class="box box-solid">
                <div class="box-body">
                    ...
                    <table class="table table-responsive table-striped">
                      <tr>
                        <?php
                        if((is_service_head() || is_national_service_manager() || is_admin() || is_ccd_incharge()  || is_service_finance() || is_service_management()) || is_service_dealer_incharge())
                        {
                        ?>
                        <td> <div name="dealer_id" id="dealer_id"></div> </td>
...
<script type="text/javascript">
    $(function(){
        <?php
            if((is_service_head() || is_national_service_manager() || is_admin() ||is_ccd_incharge()  || is_service_finance() || is_service_dealer_incharge() || is_service_management()))
            {
        ?>
    ...
    function exportExcel() {
        ...
        $("#form-crm_reports_generate").attr('action', '<?php echo site_url("admin/spareparts_report/get_dealer_stock_excel"); ?>');
