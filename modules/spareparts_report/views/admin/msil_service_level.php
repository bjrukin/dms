...
<script type="text/javascript">
    ...
    function generateReport() {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo site_url("admin/spareparts_report/msil_service_level"); ?>',
            data: data,
    ...
    function exportExcel() {
        ...
        $("#form-crm_reports_generate").attr('action', '<?php echo site_url("admin/crm-reports/excel_export_msil_service_level"); ?>');
