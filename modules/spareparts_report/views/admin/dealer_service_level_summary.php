            ...
            <div class="box-body">
                ...
                <table class="table table-responsive table-striped">
                  <tr>
                        ...
                        <td><label for="dealer_list"> Dealer </label></td>
                        <td> <div id="dealers" name = "dealer_id"> </div></td>
...
<script type="text/javascript">
    ...
    sparepart_dealerDataAdapter = new $.jqx.dataAdapter(sparepart_dealerDataSource, {autoBind: false});
    ...
    $("#dealers").jqxComboBox({
        ...
        source: sparepart_dealerDataAdapter,
        displayMember: "name",
        valueMember: "id",
    });
    ...
    function generateReport() {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo site_url("admin/spareparts_report/dealer_service_level_monitor"); ?>',
            data: data,
    ...
    function exportExcel() {
        ...
        $("#form-crm_reports_generate").attr('action', '<?php echo site_url("admin/crm-reports/excel_export_dealer_service_level_summary_monitor"); ?>');
