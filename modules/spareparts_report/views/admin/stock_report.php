            ...
            <div class="box-body">
                ...
                <table class="table table-responsive table-striped">
                  <tr>
                   ...
                   <td><div id='nep_month' name='nep_month'></div></td>                   
                   <td>
...
<script type="text/javascript">
    $(function(){
        var nepalimonthDataSource  = {
            url : '<?php echo site_url("admin/spareparts_report/get_nepali_month_list"); ?>',
            datatype: 'json',
            datafields: [
            { name: 'id', type: 'number' },
        ...
        nepalimonthDataAdapter = new $.jqx.dataAdapter(nepalimonthDataSource, {autoBind: false});

        $("#nep_month").jqxComboBox({
            theme: theme,
            width: 195,
            height: 25,
    ...
    function generateReport() {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo site_url("admin/spareparts_report/current_stock_json"); ?>',
            data: data,
    ...
    function exportExcel() {
        ...
        $("#form-crm_reports_generate").attr('action', '<?php echo site_url("admin/crm-reports/excel_export_product_in_out_register"); ?>');
