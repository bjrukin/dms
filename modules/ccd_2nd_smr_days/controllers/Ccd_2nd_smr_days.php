...
class Ccd_2nd_smr_days extends Project_Controller
{
	public function __construct()
	{
    	parent::__construct();

    	control('Ccd 2nd Smr Days');

        $this->load->model('ccd_2nd_smr_days/ccd_2nd_smr_day_model');
        $this->lang->load('ccd_2nd_smr_days/ccd_2nd_smr_day');
    }

	public function index()
	{
		// Display Page
		$data['header'] = lang('ccd_2nd_smr_days');
		$data['page'] = $this->config->item('template_admin') . "index";
		$data['module'] = 'ccd_2nd_smr_days';
	...
	public function json()
	{
		...
		$total=$this->ccd_2nd_smr_day_model->find_count();
		...
		$this->ccd_2nd_smr_day_model->_table = 'view_cc_2nd_smr';
		$this->db->where('schedule_date <=',date('Y-m-d'));
		$rows=$this->ccd_2nd_smr_day_model->findAll();
	...
	public function save()
	{
        ...
        {
            $success=$this->ccd_2nd_smr_day_model->insert($data);
        }
        else
        {
            $success=$this->ccd_2nd_smr_day_model->update($data['id'],$data);
        }
   ...
   private function _get_posted_data()
   {
        ...
        $this->db->group_by('id');
	 	$max_count = $this->ccd_2nd_smr_day_model->find();
   ...
   public function report_export_smr_113_days($value='')
    {
        ...
        $this->ccd_2nd_smr_day_model->_table = "view_cc_2nd_smr";
        $data=$this->ccd_2nd_smr_day_model->findAll($where);
