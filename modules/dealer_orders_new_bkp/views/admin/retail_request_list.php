...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><?php echo lang('menu_create_retail_request'); ?></h1>
        <ol class="breadcrumb">
            <li><a href="#">Home</a></li>
            <li class="active"><?php echo lang('menu_create_retail_request'); ?></li>
        </ol>
    </section>
    <!-- Main content -->
...
<div id="jqxPopupWindowDealer_order">
    ...
    <div class="form_fields_area">
        ...
        <input type = "hidden" name = "id" id = "dealer_orders_id" value='1'>
        <input type = "hidden" name = "in_stock_ktm" id = "in_stock_ktm" value='1'>
        <input type = "hidden" name = "is_ktm_dealer" id = "is_ktm_dealer" value='1'>
        <input type = "hidden" name = "in_stock_remarks" id = "in_stock_remarks" value='1'>
        <table class="form-table">
            ...
            <tr id="instock_div" style="display: none">
                <td></td>
                <td><span style="color:#6BF412;font-size : 20px; ">In Stock</span></td>
            </tr>
            ...
            <tr id="ktm_error_div" style="display: none">
                <td></td>
                <td><span style="color:#4980d8;font-size : 20px; ">Not Stock in Ktm</span></td>
            </tr>
            <tr>
...
<script language="javascript" type="text/javascript">
    ...
    $('#year').on('change',function()
    {
        ...
        year        = $("#year").val();
        is_ktm_dealer        = $("#is_ktm_dealer").val();
        $.post("<?php echo site_url('dealer_orders/check_stock_availability')?>",{vehicle_id:vehicle_id , variant_id:variant_id, color_id : color_id, year:year,is_ktm_dealer:is_ktm_dealer},function(result)
        {
            ...
            else if(result.success == 'out_of_stock')
            {
            ...
            else if(result.success == 'outside_ktm')
            {
                $('#in_stock_remarks').val('3');
                $('#ktm_error_div').show();
                $('#error_div').hide();
                $('#transit_error_div').hide();
                $('#instock_div').hide();
    ...
    var dealer_ordersDataSource =
    {
        ...
        url: '<?php echo site_url("admin/dealer_orders/retail_json"); ?>',
    ...
    $("#jqxGridDealer_order").jqxGrid({
        ...
        {text: '<?php echo lang("color_code"); ?>', datafield: 'color_code', width: 150, filterable: true, renderer: gridColumnsRenderer, cellclassname : cellclassname},
        ...
        {text: '<?php echo lang("payment_value"); ?>', datafield: 'payment_value', width: 160, filterable: true, renderer: gridColumnsRenderer, cellclassname : cellclassname},
...
$(document).on('click', '#jqxGridDealer_orderInsert', function () {
    openPopupWindow('jqxPopupWindowDealer_order', '<?php echo lang("general_add") . "&nbsp;" . $header; ?>');
        ...
        $('#form-dealer_orders').jqxValidator({
            ...
            /*{ input: '#quantity', message: 'Invalid Format', action: 'blur', 
            rule: function(input) {
                val = $('#quantity').val();
                return (val == '' || val == null || val == 0 || val.length > 2) ? false: true;
            } },*/
