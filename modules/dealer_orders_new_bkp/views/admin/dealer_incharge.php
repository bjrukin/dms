...
$("#jqxGridDealer_order").jqxGrid({
	...
	{text: '<?php echo lang("logistic_confirmation_date"); ?>', datafield: 'logistic_confirmation_date', width: 130, filterable: true, renderer: gridColumnsRenderer, columntype: 'date', filtertype: 'range', cellsformat: formatString_yyyy_MM_dd, cellclassname:cellclassname},
	{text: '<?php echo lang("payment_value"); ?>', datafield: 'payment_value', width: 140, filterable: true, renderer: gridColumnsRenderer, cellclassname:cellclassname},
