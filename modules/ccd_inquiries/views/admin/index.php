	...
	$("#jqxGridCcd_inquiry").jqxGrid({
		...
		{ text: 'SN', width: 50, pinned: true, exportable: false,  columntype: 'number', cellclassname: 'jqx-widget-header', renderer: gridColumnsRenderer, cellsrenderer: rownumberRenderer , filterable: false},
		{
			...
			cellsrenderer: function (index) {
				...
				{
					if(row.source_name != "Generated"){
						var e = '<a href="javascript:void(0)" onclick="editCcd_inquiryRecord(' + index + '); return false;" title="Update"><i class="fa fa-edit"></i></a>';
					}else{
						var e = '<a href="javascript:void(0)" onclick="editCcd_inquiry_generated_Record(' + index + '); return false;" title="Update"><i class="fa fa-edit"></i></a>';
					}
