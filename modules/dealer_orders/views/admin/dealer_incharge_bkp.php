...
<script language="javascript" type="text/javascript">
	...
	$(function () {
        ...
        /*{text: '<?php echo lang("grn_received_date"); ?>', datafield: 'grn_received_date', width: 90, filterable: true, renderer: gridColumnsRenderer, columntype: 'date', filtertype: 'range', cellsformat: formatString_yyyy_MM_dd, cellclassname:cellclassname},

			{
				text: '<?php echo lang("delivery_lead_time"); ?>', datafield: 'delivery_lead_time',width: 130, sortable: false, filterable: true, align: 'center', cellsalign: 'center', cellclassname: 'grid-column-center',
				cellsrenderer: function (index) {
					var row = $("#jqxGridDealer_order").jqxGrid('getrowdata', index);
