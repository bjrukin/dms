...
{	
	...
	var html = '';
	html += "<table border='1' cellspacing='0' cellpadding='0' style='width: 90%; border-collapse: collapse;'>";
	html += "<tr><th>SN</th>";
	html += "<th>Partcode</th>"; 
	html += "<th>Location</th></tr>";
	var i = 0;
...
<script type="text/javascript">
	...
	$("#jqxGridBinningList").jqxGrid({
		...
		{ text: '<?php echo lang("quantity"); ?>',datafield: 'quantity',width: 150,filterable: true,renderer: gridColumnsRenderer, align:'center', cellsalign:'center' },
