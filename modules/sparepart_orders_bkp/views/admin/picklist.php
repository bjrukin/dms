			...
			<div class="container">  
				<section class="invoice" style="max-width: 210mm;">
					<table cellspacing="0" cellpadding="0" style="width: 100%; border-collapse: collapse;">
						...
						<tr>
							<td>PI No.: <?php echo @$pi_number;?></td>
							<td class="center">Order No.: <?php echo @$dealer->prefix."-".sprintf('%04d', @$order_no);?></td>
							<td class="right" >Picklist No.: <?php echo @$picklist_number;?></td>
						</tr>
					</table>
					<table cellspacing="0" cellpadding="0" style="width: 100%; border-collapse: collapse;">
						<tr>
							<td>Order Type: <?php echo @$order_type;?></td>
							<td class="center">Dispatch Mode: <?php echo @$dispatch_mode;?></td>
							<td class="right">Picker: <?php echo @$picker_name->first_name." ".@$picker_name->middle_name." ".@$picker_name->last_name;?></td>
						</tr>
					</table>
					<table cellspacing="0" cellpadding="0" style="width: 100%; border-collapse: collapse;" border="1">
						...
						<?php foreach ($rows as $key => $value): ?>
							<tr> 
								...
								<td  style="padding-top:7px;padding-left:10px;"><?php echo substr($value['name'],0,16)?></td>
