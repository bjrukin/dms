...
<script language="javascript" type="text/javascript">
	...
	$(function(){
		...
		$("#stock_order").vor_order({ width: 250, height: 25});
		$("#vor_order").jqxRadioButton({ width: 250, height: 25});
	...
	$("#jqxGridSparepart_order").jqxGrid({
		...
		{ text: '<?php echo lang("quantity"); ?>',datafield: 'order_quantity',width: 150,filterable: true,renderer: gridColumnsRenderer },
