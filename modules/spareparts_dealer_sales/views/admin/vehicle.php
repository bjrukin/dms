...
<script type="text/javascript" src="https://www.jqwidgets.com/jquery-widgets-demo/jqwidgets/jqxgrid.export.js"></script>
...
<script language="javascript" type="text/javascript">
	...
	$(function(){
		...
		var sparepartsDataSource =
		{
			...
			{ name: 'retail_month', type: 'string' },
			{ name: 'dealer_name', type: 'string' },
			{ name: 'vehicle_delivery_date_np', type: 'string' },
			
			
			],
			url: '<?php echo site_url("admin/spareparts_dealer_sales/vehicle_json"); ?>',
	...
	$("#jqxGridSparepart").jqxGrid({
		...
		{ text: 'Retail',datafield: 'vehicle_delivery_date_np',width: 100,filterable: true, cellsformat : 'F2',renderer: gridColumnsRenderer },
		{ text: 'Retail Year',datafield: 'retail_year',width: 100,filterable: true, cellsformat : 'F2',renderer: gridColumnsRenderer },
		{ text: 'Retail Month',datafield: 'retail_month',width: 100,filterable: true, cellsformat : 'F2',renderer: gridColumnsRenderer },
...
$(document).on('click','#excelExport', function () { 
    $("#jqxGridSparepart").jqxGrid('exportdata', 'xls', 'jqxGrid');           
});
