...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><?php echo 'Report'; ?><small><?php echo $report_type; ?></small></h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url();?>"><?php echo lang('menu_home');?></a></li>
            <li><a href="<?php echo site_url('admin/stock_records/report_list');?>"><?php echo 'Report';?></a></li>
...
function generateReport() {
 ...
 //    });
    ...
    $.ajax({
        type: "POST",
        url: '<?php echo site_url("admin/stock_records/get_test_drive_report_json"); ?>',
        data: data,
...
function exportExcel() {
    ...
    $("#form-crm_reports_generate").attr('action', '<?php echo site_url("admin/stock_records/excel_export"); ?>');
