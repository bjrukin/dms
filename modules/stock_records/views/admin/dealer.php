...
$(function(){
	...
	var stock_recordsDataSource =
	{
		...
		url: '<?php echo site_url("admin/stock_records/dealer_json"); ?>',
...
//			},
			...
			{ text: '<?php echo lang("stock_yard"); ?>',datafield: 'stock_yard',width: 150,filterable: true,renderer: gridColumnsRenderer },
			{ text: '<?php echo lang("reached_date"); ?>',datafield: 'received_date',width: 150,filterable: true,renderer: gridColumnsRenderer },
			{ text: '<?php echo lang("dispatched_date"); ?>',datafield: 'date_of_delivery',width: 150,filterable: true,renderer: gridColumnsRenderer },
