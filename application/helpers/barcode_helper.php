...
function Barcode39 ($barcode,$text,$dest, $width=1224, $height=1224, $quality=100, $format="JPEG")

{
    ...
    or die ("Cannot Initialize new GD image stream");
        ...
        OutputImageToFile($im,$dest ,$format, $quality);
...
function OutputImageToFile ($im,$dest ,$format, $quality)
