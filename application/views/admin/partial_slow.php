...
<script type="text/javascript">
	...
	var partial_slow = function(){
    	 ...
    	 var slowSource =
		{
			...
			url: '<?php echo site_url('stock_records/get_slow_spareparts_stock')?>',
	        ...
	        beforeprocessing: function (data) {
	        	slowSource.totalrecords = data.total;
	        },
		   // update the grid and send a request to the server.
		    filter: function () {
		    	$("#jqxSlowstock").jqxGrid('updatebounddata', 'filter');
		    },
		    // update the grid and send a request to the server.
		    sort: function () {
		    	$("#jqxSlowstock").jqxGrid('updatebounddata', 'sort');
		    },
