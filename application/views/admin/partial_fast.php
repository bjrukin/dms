...
<script type="text/javascript">
	...
	var partial_fast = function(){
    	 ...
    	 var fastsource =
		{
			...
			url: '<?php echo site_url('stock_records/get_fast_spareparts_stock')?>',
	        ...
	        beforeprocessing: function (data) {
	        	fastsource.totalrecords = data.total;
	        },
		   // update the grid and send a request to the server.
		    filter: function () {
		    	$("#fast_stock").jqxGrid('updatebounddata', 'filter');
		    },
		    // update the grid and send a request to the server.
		    sort: function () {
		    	$("#fast_stock").jqxGrid('updatebounddata', 'sort');
		    },
