...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<!-- ./statuses -->
		<?php 
			// echo '<pre>'; print_r(inquiry_conversion_ratio_all()); exit;
			$total = 0 ;
			$status = [];
			foreach (status_count_all() as $key => $value) {
				$status[$value['status_name']] = $value['total'];
				$total += $value['total'];
			}


			$total_inquiry_kind = 0 ;
			$status_inquiry_kind = [];
			foreach (inquiry_kind_count_all() as $key => $value) {
				$status_inquiry_kind[$value['inquiry_kind']] = $value['total'];
				$total_inquiry_kind += $value['total'];
			}

			$total_inquiry_source = 0 ;
			$status_inquiry_source = [];
			foreach (inquiry_source_count_all() as $key => $value) {
				$status_inquiry_source[$value['source_name']] = $value['total'];
				$total_inquiry_source += $value['total'];
			}

			$total_inquiry_type = 0 ;
			$status_inquiry_type = [];
			foreach (inquiry_type_count_all() as $key => $value) {
				$status_inquiry_type[$value['customer_type_name']] = $value['total'];
				$total_inquiry_type += $value['total'];
			}

			$total_closed_inquiry = 0 ;
			$status_closed_inquiry = [];
			foreach (closed_inquiry_count_all() as $key => $value) {
				$status_closed_inquiry[$value['sub_status_name']] = $value['total'];
				$total_closed_inquiry += $value['total'];
			}

			$conveted_inquiry_ratio = inquiry_conversion_ratio_all();
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status['Pending']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status['Confirmed']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status['Booked']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status['Retail']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status['Closed']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format($total_inquiry_kind); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status_inquiry_kind['Warm']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status_inquiry_kind['Hot']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status_inquiry_kind['Cold']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
					...
					<div class="box-body">
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									<span class="info-box-text">Total</span>
									<span class="info-box-number"><?php echo number_format(@$total_inquiry_source); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status_inquiry_source['Walk-In']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status_inquiry_source['Generated']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status_inquiry_source['Referral']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
					...
					<div class="box-body">
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									<span class="info-box-text">Total</span>
									<span class="info-box-number"><?php echo number_format($total_inquiry_type); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status_inquiry_type['First Tyme Buyer']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status_inquiry_type['Additional Buyer']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status_inquiry_type['Suzuki to Suzuki Exchange']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status_inquiry_type['Other Brand to Suzuki Exchange']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
					...
					<div class="box-body">
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									<span class="info-box-text">Total</span>
									<span class="info-box-number"><?php echo number_format($total_closed_inquiry); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status_closed_inquiry['Lost']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status_closed_inquiry['Booking Cancel']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$status_closed_inquiry['Cancel']); ?></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-6">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$conveted_inquiry_ratio['converted_total'],2); ?> %</span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
						...
						<div class="col-md-6">
							<div class="info-box">
								...
								<div class="info-box-content">
									...
									<span class="info-box-number"><?php echo number_format(@$conveted_inquiry_ratio['not_converted_total'],2); ?> %</span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
