...
<script type="text/javascript">
	...
	var partial_none = function(){
    	 ...
    	 var nonesource =
		{
			...
			url: '<?php echo site_url('stock_records/get_none_spareparts_stock')?>',
	        ...
	        beforeprocessing: function (data) {
	        	nonesource.totalrecords = data.total;
	        },
		   // update the grid and send a request to the server.
		    filter: function () {
		    	$("#jqxNonestock").jqxGrid('updatebounddata', 'filter');
		    },
		    // update the grid and send a request to the server.
		    sort: function () {
		    	$("#jqxNonestock").jqxGrid('updatebounddata', 'sort');
		    },
