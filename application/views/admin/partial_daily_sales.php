...
<script type="text/javascript">
	...
	var partial_daily = function(){
    	 ...
    	 var dailysource =
		{
			...
			url: '<?php echo site_url('stock_records/get_daily_spareparts_sales')?>',
	        ...
	        beforeprocessing: function (data) {
	        	dailysource.totalrecords = data.total;
	        },
		   // update the grid and send a request to the server.
		    filter: function () {
		    	$("#jqxdailysales").jqxGrid('updatebounddata', 'filter');
		    },
		    // update the grid and send a request to the server.
		    sort: function () {
		    	$("#jqxdailysales").jqxGrid('updatebounddata', 'sort');
		    },
