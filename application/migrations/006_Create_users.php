    ...
    {       
        ...
        if ( ! $this->db->table_exists('aauth_users'))
        {
            ...
            $this->dbforge->add_field(array(
                ...
                'last_login'            => array('type' => 'timestamp',     'default'    => null),
                'last_activity'         => array('type' => 'timestamp',     'default'    => null),
                'date_created'          => array('type' => 'timestamp',     'default'    => null),
                'forgot_exp'            => array('type' => 'text',          'null'       => TRUE),
                'remember_time'         => array('type' => 'timestamp',     'default'    => null,   'null'     => TRUE),
