...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(APPPATH.'third_party/pdf/_class/exception.class.php');
    require_once(APPPATH.'third_party/pdf/_class/locale.class.php');
    require_once(APPPATH.'third_party/pdf/_class/myPdf.class.php');
    require_once(APPPATH.'third_party/pdf/_class/parsingHtml.class.php');
    require_once(APPPATH.'third_party/pdf/_class/parsingCss.class.php');
